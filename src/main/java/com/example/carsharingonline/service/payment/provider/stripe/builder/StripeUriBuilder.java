package com.example.carsharingonline.service.payment.provider.stripe.builder;
...
public class StripeUriBuilder {
    ...
    public static final String SUCCESS_PATH = "/public/payments/success";
    public static final String CANCEL_PATH = "/public/payments/cancel";
